...
GenericSqlBlobOutputStream::GenericSqlBlobOutputStream(GenericSqlDbRef *db, const QByteArray &tableId,
...
void GenericSqlBlobOutputStream::close() {

}

void GenericSqlBlobOutputStream::write(const char *buffer, int length, U2OpStatus &os) {
