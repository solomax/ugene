...
GenericSqlBlobInputStream::GenericSqlBlobInputStream(GenericSqlDbRef *db, const QByteArray &tableId,
...
qint64 GenericSqlBlobInputStream::available() {
    return size - offset;
}

void GenericSqlBlobInputStream::close() {

}

int GenericSqlBlobInputStream::read(char *buffer, int length, U2OpStatus &os) {
...
qint64 GenericSqlBlobInputStream::skip(qint64 n, U2OpStatus &/*os*/) {
    if (offset + n >= size) {
