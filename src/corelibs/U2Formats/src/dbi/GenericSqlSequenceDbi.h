...
#ifndef _U2_GENERIC_SQL_SEQUENCE_DBI_H_
#define _U2_GENERIC_SQL_SEQUENCE_DBI_H_
...
class U2FORMATS_EXPORT GenericSqlSequenceDbi : public U2SequenceDbi, public GenericSqlChildDbiCommon {

public:
    GenericSqlSequenceDbi(GenericSqlDbi* dbi);
    virtual ~GenericSqlSequenceDbi();
    ...
    */
    ...
    void updateSequenceData(GenericSqlModificationAction &updateAction, const U2DataId &sequenceId, const U2Region &regionToReplace, const QByteArray &dataToInsert, const QVariantMap &hints, U2OpStatus &os);
...
#endif // _U2_GENERIC_SQL_SEQUENCE_DBI_H_
