...
#ifndef _U2_GENERIC_SQL_MOD_DBI_H_
#define _U2_GENERIC_SQL_MOD_DBI_H_
...
class U2FORMATS_EXPORT GenericSqlUseCommonMultiModStep {
public:
    /**
     ...
     */
    GenericSqlUseCommonMultiModStep(GenericSqlDbi *_sqlDbi, const U2DataId &_masterObjId, U2OpStatus &os);
    virtual ~GenericSqlUseCommonMultiModStep();

private:
    GenericSqlDbi *sqlDbi;
    bool valid;
    const U2DataId &masterObjId;
};

class GenericSqlModStepsDescriptor {
public:
    GenericSqlModStepsDescriptor();
...
class U2FORMATS_EXPORT GenericSqlModDbi : public U2ModDbi, public GenericSqlChildDbiCommon {
public:
    GenericSqlModDbi(GenericSqlDbi *dbi);
    virtual ~GenericSqlModDbi();
...
protected:
    ...
    static QMap<U2DataId, GenericSqlModStepsDescriptor> modStepsByObject;
};

}   // namespace U2

#endif  // _U2_GENERIC_SQL_MOD_DBI_H_
