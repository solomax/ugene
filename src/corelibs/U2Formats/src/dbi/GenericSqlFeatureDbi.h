...
#ifndef _U2_GENERIC_SQL_FEATURE_DBI_H_
#define _U2_GENERIC_SQL_FEATURE_DBI_H_
...
class U2FORMATS_EXPORT GenericSqlFeatureDbi : public U2FeatureDbi, public GenericSqlChildDbiCommon {
public:
    GenericSqlFeatureDbi(GenericSqlDbi *dbi);
    virtual ~GenericSqlFeatureDbi();
