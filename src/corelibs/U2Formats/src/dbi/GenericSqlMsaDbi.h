...
#ifndef _U2_GENERIC_SQL_MSA_DBI_H_
#define _U2_GENERIC_SQL_MSA_DBI_H_
...
class GenericSqlModificationAction;

class GenericSqlMsaDbi : public U2MsaDbi, public GenericSqlChildDbiCommon {

public:
    GenericSqlMsaDbi(GenericSqlDbi* dbi);
    virtual ~GenericSqlMsaDbi();
     ...
     */
    virtual U2DataId createMcaObject(const QString& folder, const QString& name, const U2AlphabetId& alphabet, U2OpStatus& os);
    virtual U2DataId createMcaObject(const QString &folder, const QString &name, const U2AlphabetId &alphabet, int length, U2OpStatus &os);
...
private:
    ...
    void updateRowInfo(GenericSqlModificationAction &updateAction, const U2DataId &msaId, const U2MsaRow &row, U2OpStatus &os);
    void updateGapModel(GenericSqlModificationAction &updateAction, const U2DataId& msaId, qint64 msaRowId, const QList<U2MsaGap>& gapModel, U2OpStatus& os);
    void updateMsaLength(GenericSqlModificationAction &updateAction, const U2DataId& msaId, qint64 length, U2OpStatus &os);
};

}   // namespace U2

#endif  // _U2_GENERIC_SQL_MSA_DBI_H_
