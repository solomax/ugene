...
#ifndef _U2_GENERIC_SQL_ATTRIBUTE_DBI_H_
#define _U2_GENERIC_SQL_ATTRIBUTE_DBI_H_
...
class U2FORMATS_EXPORT GenericSqlAttributeDbi : public U2AttributeDbi, public GenericSqlChildDbiCommon {
public:
    GenericSqlAttributeDbi( GenericSqlDbi *dbi );
    virtual ~GenericSqlAttributeDbi();
...
#endif // _U2_GENERIC_SQL_ATTRIBUTE_DBI_H_
