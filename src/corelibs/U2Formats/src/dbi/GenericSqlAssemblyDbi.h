...
#ifndef _U2_GENERIC_SQL_ASSEMBLY_DBI_H_
#define _U2_GENERIC_SQL_ASSEMBLY_DBI_H_
...
class U2SqlQuery;
class GenericSqlAssemblyAdapter;

class GenericSqlAssemblyDbi : public U2AssemblyDbi, public GenericSqlChildDbiCommon {

public:
    GenericSqlAssemblyDbi(GenericSqlDbi* dbi);
    virtual ~GenericSqlAssemblyDbi();
...
#endif  // _U2_GENERIC_SQL_ASSEMBLY_DBI_H_
