...
/************************************************************************/
/* GenericSqlUseCommonMultiModStep                                      */
/************************************************************************/
GenericSqlUseCommonMultiModStep::GenericSqlUseCommonMultiModStep(GenericSqlDbi *_sqlDbi, const U2DataId &_masterObjId, U2OpStatus& os) :
    sqlDbi(_sqlDbi),
    valid(false),
    masterObjId(_masterObjId)
{
    CHECK_OP(os, );
    SAFE_POINT(NULL != sqlDbi, "Dbi is NULL", );

    sqlDbi->getSqlModDbi()->startCommonMultiModStep(masterObjId, os);
    if (!os.hasError()) {
        valid = true;
    }
}

GenericSqlUseCommonMultiModStep::~GenericSqlUseCommonMultiModStep() {
    SAFE_POINT(NULL != sqlDbi, "Dbi is NULL", );
    if (valid) {
        U2OpStatus2Log os;
        sqlDbi->getSqlModDbi()->endCommonMultiModStep(masterObjId, os);
    }
}
...
GenericSqlModStepsDescriptor::GenericSqlModStepsDescriptor() :
    userModStepId(-1),
    multiModStepId(-1),
...
/* GenericSqlModDbi                                                     */
/************************************************************************/
QMap<U2DataId, GenericSqlModStepsDescriptor> GenericSqlModDbi::modStepsByObject;

GenericSqlModDbi::GenericSqlModDbi(GenericSqlDbi *dbi) : U2ModDbi(dbi), GenericSqlChildDbiCommon(dbi) {
}

GenericSqlModDbi::~GenericSqlModDbi() {}

U2SingleModStep GenericSqlModDbi::getModStep(const U2DataId &objectId, qint64 trackVersion, U2OpStatus &os) {
    U2SingleModStep res;
...
qint64 GenericSqlModDbi::getNearestUserModStepVersion(const U2DataId &masterObjId, qint64 version, U2OpStatus &os) {
...
QList< QList<U2SingleModStep> > GenericSqlModDbi::getModSteps(const U2DataId &masterObjId, qint64 version, U2OpStatus &os) {
...
void GenericSqlModDbi::createModStep(const U2DataId &masterObjId, U2SingleModStep &step, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlModDbi::removeModsWithGreaterVersion(const U2DataId &masterObjId, qint64 masterObjVersion, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlModDbi::removeDuplicateUserStep(const U2DataId &masterObjId, qint64 masterObjVersion, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlModDbi::removeSteps(QList<qint64> userStepIds, U2OpStatus &os) {
...
void GenericSqlModDbi::removeObjectMods(const U2DataId &objectId, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlModDbi::cleanUpAllStepsOnError() {
    U2OpStatus2Log os;
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlModDbi::startCommonUserModStep(const U2DataId &masterObjId, U2OpStatus &os) {
    checkMainThread(os);
    CHECK_OP(os, );
    ...
    if (!modStepsByObject.contains(masterObjId)) {
        modStepsByObject[masterObjId] = GenericSqlModStepsDescriptor();
    }
...
void GenericSqlModDbi::endCommonUserModStep(const U2DataId &userMasterObjId, U2OpStatus &os) {
    checkMainThread(os);
    CHECK_OP(os, );
...
void GenericSqlModDbi::startCommonMultiModStep(const U2DataId &userMasterObjId, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);

    if(!modStepsByObject.contains(userMasterObjId)) {
        modStepsByObject[userMasterObjId] = GenericSqlModStepsDescriptor();
    }
...
void GenericSqlModDbi::endCommonMultiModStep(const U2DataId &masterObjId, U2OpStatus &os) {
...
void GenericSqlModDbi::createUserModStep(const U2DataId &masterObjId, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);

    qint64 masterObjVersion = dbi->getObjectDbi()->getObjectVersion(masterObjId, os);
    CHECK_OP(os, );
...
void GenericSqlModDbi::createMultiModStep(const U2DataId &masterObjId, U2OpStatus &os) {
...
bool GenericSqlModDbi::isUserStepStarted(const U2DataId& userMasterObjId) {
    if (!modStepsByObject.contains(userMasterObjId)) {
        return false;
    }
...
bool GenericSqlModDbi::isMultiStepStarted(const U2DataId& userMasterObjId) {
    if (!modStepsByObject.contains(userMasterObjId)) {
        return false;
    }
...
bool GenericSqlModDbi::canUndo(const U2DataId &objectId, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);

    // Get current object version
    qint64 objVersion = dbi->getObjectDbi()->getObjectVersion(objectId, os);
    CHECK_OP(os, false);
...
bool GenericSqlModDbi::canRedo(const U2DataId &objectId, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
