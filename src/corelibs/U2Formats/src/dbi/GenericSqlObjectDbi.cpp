...
GenericSqlObjectDbi::GenericSqlObjectDbi(GenericSqlDbi* dbi) :
    U2ObjectDbi(dbi),
    GenericSqlChildDbiCommon(dbi)
{
}

GenericSqlObjectDbi::~GenericSqlObjectDbi() {}

//////////////////////////////////////////////////////////////////////////
// Read methods for objects
#define TOP_LEVEL_FILTER ("rank = " + QString::number(U2DbiObjectRank_TopLevel))

qint64 GenericSqlObjectDbi::countObjects(U2OpStatus& os) {
...
qint64 GenericSqlObjectDbi::countObjects(U2DataType type, U2OpStatus& os) {
...
QList<U2DataId> GenericSqlObjectDbi::getObjects(qint64 offset, qint64 count, U2OpStatus& os) {
...
QList<U2DataId> GenericSqlObjectDbi::getObjects(U2DataType type, qint64 offset, qint64 count, U2OpStatus& os) {
...
QList<U2DataId> GenericSqlObjectDbi::getParents(const U2DataId& entityId, U2OpStatus& os) {
...
U2DbiIterator<U2DataId>* GenericSqlObjectDbi::getObjectsByVisualName(const QString& visualName, U2DataType type, U2OpStatus& os) {
    ...
    return new GenericSqlRSIterator<U2DataId>(q, new GenericSqlDataIdRSLoaderEx(), NULL, U2DataId(), os);
}
...
QStringList GenericSqlObjectDbi::getFolders(U2OpStatus& os) {
...
QHash<U2Object, QString> GenericSqlObjectDbi::getObjectFolders(U2OpStatus &os) {
...
void GenericSqlObjectDbi::renameFolder(const QString &oldPath, const QString &newPath, U2OpStatus &os) {
...
QString GenericSqlObjectDbi::getFolderPreviousPath(const QString &currentPath, U2OpStatus &os) {
...
qint64 GenericSqlObjectDbi::countObjects(const QString& folder, U2OpStatus& os) {
...
QList<U2DataId> GenericSqlObjectDbi::getObjects(const QString& folder, qint64 offset, qint64 count, U2OpStatus& os) {
    const QString canonicalFolder = U2DbiUtils::makeFolderCanonical(folder);
    const QByteArray hash = QCryptographicHash::hash(canonicalFolder.toLatin1(), QCryptographicHash::Md5).toHex();
...
QStringList GenericSqlObjectDbi::getObjectFolders(const U2DataId& objectId, U2OpStatus& os) {
...
qint64 GenericSqlObjectDbi::getFolderLocalVersion(const QString& folder, U2OpStatus& os) {
    const QString canonicalFolder = U2DbiUtils::makeFolderCanonical(folder);
    const QByteArray hash = QCryptographicHash::hash(canonicalFolder.toLatin1(), QCryptographicHash::Md5).toHex();
...
qint64 GenericSqlObjectDbi::getFolderGlobalVersion(const QString& folder, U2OpStatus& os) {
    const QString canonicalFolder = U2DbiUtils::makeFolderCanonical(folder);
    const QByteArray hash = QCryptographicHash::hash(canonicalFolder.toLatin1(), QCryptographicHash::Md5).toHex();
...
bool GenericSqlObjectDbi::removeObject(const U2DataId& dataId, bool force, U2OpStatus& os) {
...
bool GenericSqlObjectDbi::removeObject(const U2DataId &dataId, U2OpStatus &os) {
...
bool GenericSqlObjectDbi::removeObjects(const QList<U2DataId>& dataIds, bool force, U2OpStatus& os) {
    Q_UNUSED(force)
    ...
    const int residualBindQueryCount = idsCount % GenericSqlDbi::BIND_PARAMETERS_LIMIT;
    const int fullBindQueryCount = idsCount / GenericSqlDbi::BIND_PARAMETERS_LIMIT;
    ...
    if (fullBindQueryCount > 0) {
        fullQueryStr = createDeleteObjectQueryStr(GenericSqlDbi::BIND_PARAMETERS_LIMIT);
    }
    ...
    if (fullBindQueryCount > 0) {
        ...
        for (int row = 0; row < fullBindQueryCount; ++row) {
            for (int col = 0; col < GenericSqlDbi::BIND_PARAMETERS_LIMIT; ++col) {
                fullDeletionQuery.addBindDataId(dataIds.at(residualBindQueryCount + row * GenericSqlDbi::BIND_PARAMETERS_LIMIT + col));
            }
...
bool GenericSqlObjectDbi::removeObjects(const QList<U2DataId> &dataIds, U2OpStatus &os) {
    return removeObjects(dataIds, false, os);
}

void GenericSqlObjectDbi::renameObject(const U2DataId &id, const QString &newName, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::createFolder(const QString& path, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
    CHECK_OP(os, );
...
bool GenericSqlObjectDbi::removeFolder(const QString& folder, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::addObjectsToFolder(const QList<U2DataId>& objectIds, const QString& folder, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::moveObjects(const QList<U2DataId>& objectIds, const QString& fromFolder,
...
QStringList GenericSqlObjectDbi::restoreObjects(const QList<U2DataId> &objectIds, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::updateObjectAccessTime(const U2DataId &objectId, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::undo(const U2DataId& objId, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
    ...
    qint64 userModStepVersion = dbi->getSqlModDbi()->getNearestUserModStepVersion(objId, obj.version - 1, os);
    if (os.hasError()) {
    ...
    QList< QList<U2SingleModStep> > modSteps = dbi->getSqlModDbi()->getModSteps(objId, userModStepVersion, os);
    if (os.hasError()) {
...
void GenericSqlObjectDbi::redo(const U2DataId& objId, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
    ...
    QList< QList<U2SingleModStep> > modSteps = dbi->getSqlModDbi()->getModSteps(objId, obj.version, os);
    if (os.hasError()) {
        coreLog.trace("Error getting modSteps for an object: " + os.getError());
        os.setError(errorDescr);
        return;
...
bool GenericSqlObjectDbi::canUndo(const U2DataId& objId, U2OpStatus& os) {
    return dbi->getSqlModDbi()->canUndo(objId, os);
}

bool GenericSqlObjectDbi::canRedo(const U2DataId& objId, U2OpStatus& os) {
    return dbi->getSqlModDbi()->canRedo(objId, os);
}
...
U2DataId GenericSqlObjectDbi::createObject(U2Object& object, const QString& folder, U2DbiObjectRank rank, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::setObjectRank(const U2DataId &objectId, U2DbiObjectRank newRank, U2OpStatus& os) {
...
void GenericSqlObjectDbi::getObject(U2Object& object, const U2DataId& id, U2OpStatus& os) {
...
U2DataId GenericSqlObjectDbi::getObject(qint64 objectId, U2OpStatus& os) {
...
QHash<U2DataId, QString> GenericSqlObjectDbi::getObjectNames(qint64 offset, qint64 count, U2OpStatus &os) {
...
void GenericSqlObjectDbi::updateObject(U2Object& obj, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
qint64 GenericSqlObjectDbi::getFolderId(const QString& path, bool mustExist, GenericSqlDbRef* db, U2OpStatus& os) {
    const QString canonicalPath = U2DbiUtils::makeFolderCanonical(path);
    const QByteArray hash = QCryptographicHash::hash(canonicalPath.toLatin1(), QCryptographicHash::Md5).toHex();
...
void GenericSqlObjectDbi::incrementVersion(const U2DataId& objectId, GenericSqlDbRef* db, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
qint64 GenericSqlObjectDbi::getObjectVersion(const U2DataId& objectId, U2OpStatus& os) {
...
void GenericSqlObjectDbi::setTrackModType(const U2DataId& objectId, U2TrackModType trackModType, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
U2TrackModType GenericSqlObjectDbi::getTrackModType(const U2DataId& objectId, U2OpStatus& os) {
...
void GenericSqlObjectDbi::removeParent(const U2DataId& parentId, const U2DataId& childId, bool removeDeadChild, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::setParent(const U2DataId& parentId, const U2DataId& childId, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::updateObjectCore(U2Object &obj, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::updateObjectType(U2Object &obj, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
bool GenericSqlObjectDbi::isObjectInUse(const U2DataId& id, U2OpStatus& os) {
...
QList<U2DataId> GenericSqlObjectDbi::getAllObjectsInUse(U2OpStatus &os) {
...
void GenericSqlObjectDbi::removeObjectFromFolder(const U2DataId &id, const QString &folder, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::removeObjectFromAllFolders(const U2DataId &id, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
bool GenericSqlObjectDbi::removeObjectImpl(const U2DataId& objectId, bool force, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
    ...
    GenericSqlUtils::remove("Object", "id", objectId, 1, db, os);

    return !os.hasError();
}

void GenericSqlObjectDbi::removeObjectSpecificData(const U2DataId &objectId, U2OpStatus &os) {
    ...
    case U2Type::Mca:
    case U2Type::Msa:
        dbi->getSqlMsaDbi()->deleteRowsData(objectId, os);
        break;
    case U2Type::AnnotationTable:
        dbi->getFeatureDbi()->removeAnnotationTableData(objectId, os);
        break;
...
void GenericSqlObjectDbi::removeObjectAttributes(const U2DataId& id, U2OpStatus& os) {
    dbi->getAttributeDbi()->removeObjectAttributes(id, os);
}

void GenericSqlObjectDbi::removeObjectModHistory(const U2DataId& id, U2OpStatus& os) {
    dbi->getModDbi()->removeObjectMods(id, os);
}

void GenericSqlObjectDbi::incrementVersion(const U2DataId& id, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::setVersion(const U2DataId& id, qint64 version, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::undoSingleModStep(const U2SingleModStep& modStep, U2OpStatus& os) {
    // TODO: add chromatogramModType and remove mcaModType
    if (U2ModType::isMcaModType(modStep.modType)) {
        dbi->getSqlMsaDbi()->undo(modStep.objectId, modStep.modType, modStep.details, os);
    } else if (U2ModType::isMsaModType(modStep.modType)) {
        dbi->getSqlMsaDbi()->undo(modStep.objectId, modStep.modType, modStep.details, os);
    } else if (U2ModType::isSequenceModType(modStep.modType)) {
        dbi->getSqlSequenceDbi()->undo(modStep.objectId, modStep.modType, modStep.details, os);
...
void GenericSqlObjectDbi::redoSingleModStep(const U2SingleModStep& modStep, U2OpStatus &os) {
    // TODO: add chromatogramModType and remove mcaModType
    if (U2ModType::isMcaModType(modStep.modType)) {
        dbi->getSqlMsaDbi()->redo(modStep.objectId, modStep.modType, modStep.details, os);
    } else if (U2ModType::isMsaModType(modStep.modType)) {
        dbi->getSqlMsaDbi()->redo(modStep.objectId, modStep.modType, modStep.details, os);
    } else if (U2ModType::isSequenceModType(modStep.modType)) {
        dbi->getSqlSequenceDbi()->redo(modStep.objectId, modStep.modType, modStep.details, os);
    } else if (U2ModType::isObjectModType(modStep.modType)) {
...
void GenericSqlObjectDbi::undoCore(const U2DataId &objId, qint64 modType, const QByteArray &modDetails, U2OpStatus &os) {
...
void GenericSqlObjectDbi::redoCore(const U2DataId &objId, qint64 modType, const QByteArray &modDetails, U2OpStatus &os) {
    if (U2ModType::objUpdatedName == modType) {
...
void GenericSqlObjectDbi::undoUpdateObjectName(const U2DataId& id, const QByteArray& modDetails, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::redoUpdateObjectName(const U2DataId& id, const QByteArray& modDetails, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectDbi::onFolderUpdated(const QString& ) {
    // Do nothing.
}
