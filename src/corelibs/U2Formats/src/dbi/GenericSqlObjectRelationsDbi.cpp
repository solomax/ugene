...
GenericSqlObjectRelationsDbi::GenericSqlObjectRelationsDbi(GenericSqlDbi *dbi)
    : U2ObjectRelationsDbi(dbi), GenericSqlChildDbiCommon(dbi)
{
}

GenericSqlObjectRelationsDbi::~GenericSqlObjectRelationsDbi() {}

void GenericSqlObjectRelationsDbi::createObjectRelation( U2ObjectRelation &relation, U2OpStatus &os ) {
...
QList<U2ObjectRelation> GenericSqlObjectRelationsDbi::getObjectRelations( const U2DataId &object,
    U2OpStatus &os )
{
...
QList<U2DataId> GenericSqlObjectRelationsDbi::getReferenceRelatedObjects( const U2DataId &reference,
...
void GenericSqlObjectRelationsDbi::removeObjectRelation( U2ObjectRelation &relation, U2OpStatus &os ) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectRelationsDbi::removeAllObjectRelations( const U2DataId &object, U2OpStatus &os ) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlObjectRelationsDbi::removeReferencesForObject( const U2DataId &object, U2OpStatus &os ) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
