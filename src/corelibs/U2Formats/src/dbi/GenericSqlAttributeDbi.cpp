...
GenericSqlAttributeDbi::GenericSqlAttributeDbi( GenericSqlDbi *dbi )
    : U2AttributeDbi( dbi ), GenericSqlChildDbiCommon( dbi )
{
}

GenericSqlAttributeDbi::~GenericSqlAttributeDbi() {}

/** Returns all attribute names available in the database */
QStringList GenericSqlAttributeDbi::getAvailableAttributeNames(U2OpStatus& os) {
...
QList<U2DataId> GenericSqlAttributeDbi::getObjectAttributes(const U2DataId& objectId, const QString& name, U2OpStatus& os) {
    if (name.isEmpty()) {
...
/** Returns all attribute ids for the given object */
QList<U2DataId> GenericSqlAttributeDbi::getObjectPairAttributes(const U2DataId& objectId, const U2DataId& childId, const QString& name, U2OpStatus& os) {
    if (name.isEmpty()) {
...
U2IntegerAttribute GenericSqlAttributeDbi::getIntegerAttribute(const U2DataId& attributeId, U2OpStatus& os) {
...
U2RealAttribute GenericSqlAttributeDbi::getRealAttribute(const U2DataId& attributeId, U2OpStatus& os) {
...
U2StringAttribute GenericSqlAttributeDbi::getStringAttribute(const U2DataId& attributeId, U2OpStatus& os) {
...
U2ByteArrayAttribute GenericSqlAttributeDbi::getByteArrayAttribute(const U2DataId& attributeId, U2OpStatus& os) {
...
QList<U2DataId> GenericSqlAttributeDbi::sort(const U2DbiSortConfig& , qint64 , qint64 , U2OpStatus& os) {
...
*/
void GenericSqlAttributeDbi::removeAttributes(const QList<U2DataId>& attributeIds, U2OpStatus& os) {
...
void GenericSqlAttributeDbi::removeObjectAttributes(const U2DataId& objectId, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
 ...
 * Requires U2DbiFeature_WriteAttribute feature support
 */
void GenericSqlAttributeDbi::createIntegerAttribute(U2IntegerAttribute& a, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
Requires U2DbiFeature_WriteAttribute feature support
*/
void GenericSqlAttributeDbi::createRealAttribute(U2RealAttribute& a, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
Requires U2DbiFeature_WriteAttribute feature support
*/
void GenericSqlAttributeDbi::createStringAttribute(U2StringAttribute& a, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
Requires U2DbiFeature_WriteAttribute feature support
*/
void GenericSqlAttributeDbi::createByteArrayAttribute(U2ByteArrayAttribute& a, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
qint64 GenericSqlAttributeDbi::createAttribute(U2Attribute& attr, U2DataType type, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
QString GenericSqlAttributeDbi::buildSelectAttributeQuery(const QString& attributeTable) {
...
void GenericSqlAttributeDbi::readAttribute(U2SqlQuery &q, U2Attribute& attr) {
    if (!q.step()) {
        if (!q.hasError()) {
