...
#ifndef _U2_GENERIC_SQL_DBI_UTILS_H_
#define _U2_GENERIC_SQL_DBI_UTILS_H_
...
class U2FORMATS_EXPORT GenericSqlDbiUtils {
public:
     ...
     */
    static void renameObject(GenericSqlDbi* dbi, U2Object& object, const QString& newName,
        U2OpStatus& os);
    static void renameObject(GenericSqlModificationAction& updateAction, GenericSqlDbi* dbi,
...
#endif // _U2_GENERIC_SQL_DBI_UTILS_H_
