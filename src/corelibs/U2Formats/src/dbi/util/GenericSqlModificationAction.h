...
#ifndef _U2_GENERIC_SQL_MODIFICATION_ACTION_H_
#define _U2_GENERIC_SQL_MODIFICATION_ACTION_H_
...
public:
    GenericSqlModificationAction(GenericSqlDbi* dbi, const U2DataId& masterObjId);
...
#endif // _U2_GENERIC_SQL_MODIFICATION_ACTION_H_
