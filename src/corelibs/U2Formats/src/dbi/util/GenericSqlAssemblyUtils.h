...
#ifndef _U2_GENERIC_SQL_ASSEMBLY_UTILS_H_
#define _U2_GENERIC_SQL_ASSEMBLY_UTILS_H_
...
enum GenericSqlAssemblyDataMethod {
    /** Merges Name, Sequence, Cigar and Quality values into single byte array separated by '\n' character. Merge prefix is '0'*/
    GenericSqlAssemblyDataMethod_NSCQ = 1
};

class GenericSqlAssemblyUtils {
public:
    static QByteArray packData(GenericSqlAssemblyDataMethod method, const U2AssemblyRead &read, U2OpStatus& os);
...
#endif // _U2_GENERIC_SQL_ASSEMBLY_UTILS_H_
