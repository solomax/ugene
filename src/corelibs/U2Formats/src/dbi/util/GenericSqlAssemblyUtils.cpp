...
QByteArray GenericSqlAssemblyUtils::packData(GenericSqlAssemblyDataMethod method, const U2AssemblyRead &read, U2OpStatus& os) {
    ...
    SAFE_POINT_EXT(method == GenericSqlAssemblyDataMethod_NSCQ, os.setError(QString("Unsupported packing method: %1").arg(method)), "");
...
void GenericSqlAssemblyUtils::unpackData(const QByteArray& packedData, U2AssemblyRead &read, U2OpStatus& os) {
...
void GenericSqlAssemblyUtils::calculateCoverage(U2SqlQuery& q, const U2Region& r, U2AssemblyCoverageStat& coverage, U2OpStatus& os) {
...
void GenericSqlAssemblyUtils::addToCoverage(U2AssemblyCoverageImportInfo& ii, const U2AssemblyRead& read) {
