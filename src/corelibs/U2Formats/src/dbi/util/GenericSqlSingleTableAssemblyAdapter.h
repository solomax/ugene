...
#ifndef _U2_GENERIC_SQL_ASSEMBLY_SINGLE_TABLE_DBI_H_
#define _U2_GENERIC_SQL_ASSEMBLY_SINGLE_TABLE_DBI_H_
...
class GenericSqlSingleTableAssemblyAdapter : public GenericSqlAssemblyAdapter {
public:
    GenericSqlSingleTableAssemblyAdapter(GenericSqlDbi* dbi, const U2DataId& assemblyId, char tablePrefix, const QString& tableSuffix,
        const AssemblyCompressor* compressor, GenericSqlDbRef* ref, U2OpStatus& os);
...
class GenericSqlSingleTablePackAlgorithmAdapter : public PackAlgorithmAdapter {
public:
    GenericSqlSingleTablePackAlgorithmAdapter(GenericSqlDbRef* db, const QString& readsTable);
    ~GenericSqlSingleTablePackAlgorithmAdapter();
...
#endif  //_U2_GENERIC_SQL_ASSEMBLY_SINGLE_TABLE_DBI_H_
