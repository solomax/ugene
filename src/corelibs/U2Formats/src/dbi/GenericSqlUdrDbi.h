...
#ifndef _U2_GENERIC_SQL_UDR_DBI_H_
#define _U2_GENERIC_SQL_UDR_DBI_H_
...
class GenericSqlUdrDbi : public UdrDbi, public GenericSqlChildDbiCommon {
public:
    GenericSqlUdrDbi(GenericSqlDbi *dbi);
    virtual ~GenericSqlUdrDbi();
...
protected:
    ...
    virtual void createTable(const UdrSchema *schema, U2OpStatus &os) = 0;
    virtual void createIndex(const UdrSchemaId &schemaId, const QStringList &fields, U2OpStatus &os) = 0;
    ...
    virtual QString tableStartDef(const UdrSchemaId &schemaId) = 0;
    virtual QString fieldDef(const UdrSchema::FieldDesc &field) = 0;
    virtual QString foreignKeysDef(const UdrSchema *schema, U2OpStatus &os) = 0;
    ...
    static const QString TABLE_PREFIX;
    static inline QString tableName(const UdrSchemaId &schemaId) {
...
#endif // _U2_GENERIC_SQL_UDR_DBI_H_
