...
#ifndef _U2_GENERIC_SQL_OBJECT_DBI_H_
#define _U2_GENERIC_SQL_OBJECT_DBI_H_

#include "GenericSqlDbi.h"

namespace U2 {

class U2FORMATS_EXPORT GenericSqlObjectDbi : public U2ObjectDbi, public GenericSqlChildDbiCommon {
public:
    GenericSqlObjectDbi(GenericSqlDbi* dbi);
    virtual ~GenericSqlObjectDbi();
    ...
    */
    ...
    /**
        ...
        */
    static qint64 getFolderId(const QString& path, bool mustExist, GenericSqlDbRef* db, U2OpStatus& os);

    /** Increment object version count */
    static void incrementVersion(const U2DataId& id, GenericSqlDbRef* db, U2OpStatus& os);
...
#endif // _U2_GENERIC_SQL_OBJECT_DBI_H_
