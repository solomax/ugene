...
GenericSqlFeatureDbi::GenericSqlFeatureDbi(GenericSqlDbi* dbi)
    : U2FeatureDbi(dbi), GenericSqlChildDbiCommon(dbi)
{
}

GenericSqlFeatureDbi::~GenericSqlFeatureDbi() {}
...
class GenericSqlFeatureRSLoader : public GenericSqlRSLoader<U2Feature> {
public:
...
class GenericSqlFeatureFilter: public GenericSqlRSFilter<U2Feature>{
public:
    GenericSqlFeatureFilter(const QString& name, const U2DataId& _seqId){
        nameToFilter = name;
        seqId = _seqId;
    }
...
void GenericSqlFeatureDbi::createAnnotationTableObject(U2AnnotationTable &table,
    const QString &folder, U2OpStatus &os)
{
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);

    dbi->getSqlObjectDbi()->createObject(table, folder, U2DbiObjectRank_TopLevel, os);
    CHECK_OP(os,);
...
U2AnnotationTable GenericSqlFeatureDbi::getAnnotationTableObject(const U2DataId &tableId,
    U2OpStatus &os)
{
...
void GenericSqlFeatureDbi::removeAnnotationTableData(const U2DataId &tableId, U2OpStatus &os) {
...
U2Feature GenericSqlFeatureDbi::getFeature(const U2DataId& featureId, U2OpStatus& os) {
    U2Feature res;
    ...
    if (q.step()) {
        res = GenericSqlFeatureRSLoader::loadStatic(&q);
    } else if (!os.hasError()) {
...
QSharedPointer<U2SqlQuery> GenericSqlFeatureDbi::createFeatureQuery(const QString &selectPart, const FeatureQuery &fq, bool useOrder, U2OpStatus &os) {
    QString wherePart;
    int n = 0;
...
qint64 GenericSqlFeatureDbi::countFeatures(const FeatureQuery &fq, U2OpStatus &os) {
...
U2DbiIterator<U2Feature>* GenericSqlFeatureDbi::getFeatures(const FeatureQuery& fq, U2OpStatus& os) {
    QSharedPointer<U2SqlQuery> q = createFeatureQuery("SELECT " + getFeatureFields(), fq, true, os);
    CHECK_OP(os, NULL);

    return new GenericSqlRSIterator<U2Feature>(q, new GenericSqlFeatureRSLoader(), NULL, U2Feature(), os);
}

QList<U2FeatureKey> GenericSqlFeatureDbi::getFeatureKeys(const U2DataId& featureId, U2OpStatus& os) {
...
void addFeatureKeys(const QList<U2FeatureKey> &keys, const U2DataId &featureId, GenericSqlDbRef *db, U2OpStatus& os) {
    CHECK(!keys.isEmpty(), );
...
void GenericSqlFeatureDbi::createFeature(U2Feature& feature, const QList<U2FeatureKey>& keys, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlFeatureDbi::addKey(const U2DataId& featureId, const U2FeatureKey& key, U2OpStatus& os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlFeatureDbi::removeAllKeys(const U2DataId& featureId, const QString& keyName, U2OpStatus& os) {
...
void GenericSqlFeatureDbi::removeKey(const U2DataId &featureId, const U2FeatureKey &key, U2OpStatus &os) {
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
...
void GenericSqlFeatureDbi::updateName(const U2DataId& featureId, const QString& newName, U2OpStatus& os){
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
...
void GenericSqlFeatureDbi::updateParentId(const U2DataId& featureId, const U2DataId& parentId, U2OpStatus& os){
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
...
void GenericSqlFeatureDbi::updateSequenceId(const U2DataId &featureId, const U2DataId &seqId,
    U2OpStatus &os)
{
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
...
void GenericSqlFeatureDbi::updateKeyValue(const U2DataId& featureId, const U2FeatureKey& key, U2OpStatus& os){
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
...
bool GenericSqlFeatureDbi::getKeyValue(const U2DataId &featureId, U2FeatureKey &key, U2OpStatus &os) {
...
void GenericSqlFeatureDbi::updateLocation(const U2DataId& featureId, const U2FeatureLocation& location, U2OpStatus& os) {
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlFeatureDbi::updateType(const U2DataId &featureId, U2FeatureType newType, U2OpStatus &os) {
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
...
void GenericSqlFeatureDbi::removeFeature(const U2DataId& featureId, U2OpStatus& os) {
    DBI_TYPE_CHECK(featureId, U2Type::Feature, os,);
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);
...
void GenericSqlFeatureDbi::removeFeaturesByParent(const U2DataId &parentId, U2OpStatus &os,
...
void executeDeleteFeaturesByParentsQuery(const QList<U2DataId> &parentIds, GenericSqlDbRef *db, U2OpStatus &os) {
...
void GenericSqlFeatureDbi::removeFeaturesByParents(const QList<U2DataId> &parentIds, U2OpStatus &os) {
    GenericSqlTransaction t(db, os);
    Q_UNUSED(t);

    int parentsNumber = parentIds.count();
    if(parentsNumber <= GenericSqlDbi::BIND_PARAMETERS_LIMIT) {
        ...
        while(parentsNumber - deletedFeaturesNumber > 0) {
            int numDeletions = parentsNumber - deletedFeaturesNumber >= GenericSqlDbi::BIND_PARAMETERS_LIMIT ? GenericSqlDbi::BIND_PARAMETERS_LIMIT : -1;
            ...
            deletedFeaturesNumber += GenericSqlDbi::BIND_PARAMETERS_LIMIT;
        }
    }
}

void GenericSqlFeatureDbi::removeFeaturesByRoot(const U2DataId &rootId, U2OpStatus &os,
    SubfeatureSelectionMode mode)
{
...
U2DbiIterator<U2Feature>* GenericSqlFeatureDbi::getFeaturesByRegion(const U2Region& reg,
    ...
    bool contains)
{
    ...
    return new GenericSqlRSIterator<U2Feature>(q, new GenericSqlFeatureRSLoader(),
        new GenericSqlFeatureFilter(featureName, seqId), U2Feature(), os);
}

U2DbiIterator<U2Feature> * GenericSqlFeatureDbi::getFeaturesBySequence(const QString &featureName,
...
U2DbiIterator<U2Feature> * GenericSqlFeatureDbi::getFeaturesByParent(const U2DataId &parentId,
...
U2DbiIterator<U2Feature> * GenericSqlFeatureDbi::getFeaturesByRoot(const U2DataId &rootId, const FeatureFlags &types, U2OpStatus &os) {
    const QString queryStringk("SELECT " + getFeatureFields() + " FROM Feature AS f "
    ...
    q->bindDataId(":root", rootId);
    return new GenericSqlRSIterator<U2Feature>(q, new GenericSqlFeatureRSLoader(),
        new GenericSqlFeatureFilter(QString(), U2DataId()), U2Feature(), os);
}

U2DbiIterator<U2Feature> * GenericSqlFeatureDbi::getFeaturesByName(const U2DataId &rootId, const QString &name, const FeatureFlags &types, U2OpStatus &os) {
    const QString queryStringk("SELECT " + getFeatureFields() + " FROM Feature AS f "
    ...
    CHECK_OP(os, NULL);
    return new GenericSqlRSIterator<U2Feature>(q, new GenericSqlFeatureRSLoader(), new GenericSqlFeatureFilter(QString(), U2DataId()), U2Feature(), os);
}

QList<FeatureAndKey> GenericSqlFeatureDbi::getFeatureTable(const U2DataId &rootFeatureId, U2OpStatus &os) {
    ...
    while (q.step()) {
        FeatureAndKey fnk;
        fnk.feature = GenericSqlFeatureRSLoader::loadStatic(&q);
...
QMap<U2DataId, QStringList> GenericSqlFeatureDbi::getAnnotationTablesByFeatureKey(const QStringList &values, U2OpStatus &os) {
    ...
    CHECK_EXT(values.size() < GenericSqlDbi::BIND_PARAMETERS_LIMIT, os.setError("Too many search terms provided"), result);
