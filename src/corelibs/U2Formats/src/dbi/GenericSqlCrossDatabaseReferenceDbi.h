...
#ifndef _U2_GENERIC_SQL_CROSS_DATABASE_REFERENCE_DBI_H_
#define _U2_GENERIC_SQL_CROSS_DATABASE_REFERENCE_DBI_H_

#include "GenericSqlDbi.h"

namespace U2 {

class U2FORMATS_EXPORT GenericSqlCrossDatabaseReferenceDbi : public U2CrossDatabaseReferenceDbi, public GenericSqlChildDbiCommon {
public:
    GenericSqlCrossDatabaseReferenceDbi(GenericSqlDbi* dbi);
    virtual ~GenericSqlCrossDatabaseReferenceDbi();
...
#endif // _U2_GENERIC_SQL_CROSS_DATABASE_REFERENCE_DBI_H_
