...
#ifndef _U2_GENERIC_SQL_VARIANT_DBI_H_
#define _U2_GENERIC_SQL_VARIANT_DBI_H_
...
class GenericSqlVariantDbi : public U2VariantDbi, public GenericSqlChildDbiCommon {
public:
    GenericSqlVariantDbi(GenericSqlDbi* dbi);
    virtual ~GenericSqlVariantDbi();
...
#endif // _U2_GENERIC_SQL_VARIANT_DBI_H_
